...
<main>
    <div style="margin-bottom:10px; font-size: smaller; margin-top: 0">
        <a href="../folders/list.php" class="back-btn lift">
            ← Назад к папкам
        </a>
    </div>
    ...
    <section>
        ...
        <p><strong>Папка:</strong> <?= htmlspecialchars($material['folder_name'] ?? 'Не указана') ?></p>
        <p><strong>Формат материала:</strong> <?= htmlspecialchars($material['type_name'] ?? 'Не указан') ?></p>
    ...
    <div class="action-bar-compact">
        ...
        <!-- Добавить -->
        <form action="../materials/add.php" method="get">
